...
world/image-fit-production/env/impl = \
...
world/image-fit-production/env = \
	$(call world/image-fit-production/env/impl,$(strip $(1)))

world/image-fit-production = \
	$(call world/image-fit-production/env, $(1)) \
