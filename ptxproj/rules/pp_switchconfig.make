...
$(STATEDIR)/pp_switchconfig.targetinstall:
	...
	@$(call install_copy, pp_switchconfig, 0, 0, 0755, -, /etc/init.d/pp_switchconfig)
	@$(call install_link, pp_switchconfig, ../init.d/pp_switchconfig, /etc/rc.d/S90_pp_switchconfig)
